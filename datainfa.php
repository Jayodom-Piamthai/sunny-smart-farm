...
<div class="crown">
    ...
    <div class="dataitem">
        ...
        <div class="image-container">
            <img src="public/images/sensors/infared.jpg" alt="Image Description"width="400" height="400" 
        ...
        <div class="data-box">
            <h1 style="color: rgb(0, 0, 0);left:10%">
            เซ็นเซอร์ตรวจจับวัตถุสิ่งกีดขวางและเส้นขาวดำแบบอินฟาเรด 
            IR Infrared Obstacle Detection Sensor
            เซ็นเซอร์ใช้ตรวจจับวัตถุโดยใช้หลักการสะท้อนของแสงเมื่อไปชนวัตถุ (Reflective) 
            สามารถปรับความไวในการตรวจจับได้ 
            ใช้แสงอินฟาเรดในการตรวจจับ
            
                รายละเอียดสินค้า
            - สามารถตรวจจับวัตถุได้ในระยะ 2 - 30 เซ็นติเมตร
            - ใช้แรงดันไฟฟ้าในการทำงาน 3V - 5.5V
            - ใช้หลักการสะท้อนของแสงในการตรวจจับ โดยมีหลอด LED อินฟาเรดส่งแสง 
               และมีโฟโต้ทรานซิสเตอร์ในการรับแสง
            - สามารถแยกสีขาว - ดำ ได้ดี
            - ใช้ไอซีเปรียบเทียบแรงดันเบอร์ LM393
            </h1>
            </div>
            <div class="link-box" style="margin-left: 10%; margin-top: 400px; position: relative; top: 100px; left: 18%">
