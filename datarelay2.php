...
<div class="crown">
    ...
    <div class="stuff">
    <div class="dataitem">
        <h1 style="color: rgb(0, 0, 0); text-align: center;"style="font-size: 90px">Relay 2 Slot</h1>
        <pre>
        <div class="image-container">
            <img src="public/images/sensors/relay2.jpg" alt="Image Description"width="400" height="400" 
        ...
        <div class="data-box">
            <h1 style="color: rgb(0, 0, 0);">
                บอร์ดรีเลย์ ภ ช่อง 5 โวลต์ 10A 250V สำหรับ arduino และ 
            microcontroller บอร์ด รีเลย์ 5V 2ช่อง
            ควบคุมเปิด/ปิด รีเลย์ได้ 4 ช่อง ใช้ไฟเข้า 5 โวลต์ ส่งสัญญาณควบคุม
            แบบ Active Low ใช้ง่าย ถ้าต้องการ
            ให้รีเลย์ติดส่งสัญญาณ 0 ไป ถ้าต้องการให้ดับส่งสัญญาณ 1 ไป
            วงจรเป็นแบบแยกกราวด์ Opto isolated
            Relay ปลอดภัยต่อวงจรไมโครคอนโทรเลอร์การเชื่อมต่อมาตรฐาน
            ที่สามารถใช้ควบคุมได้โดยตรงจากไมโครคอนโทรนเลอร์
            เช่น  Arduino , 8051, AVR, PIC,DSP,ARM, ARM, MSP430, TTL logic)
            ใช้ไฟฟ้าที่ 5 โวลต์
            สามารถ 5 โวลต์จากบอร์ด arduino ที่มีขา 5 โวลต์ได้
            ...
            <div class="link-box" style="margin-left: 10%; margin-top: 30px; position: relative; top: -50px; left: -70%">
                <a href="https://www.cybertice.com/product/5/arduino-relay-2%E0%B8%8A%E0%B9%88%E0%B8%AD%E0%B8%87-5v-relay-module-active-low-5v-2-channel-isolation-control-250v-10a" style="color: rgb(0, 0, 0); ">
                    <h1> ตัวอย่างการต่อวงจรและเขียนโปรแกรม</h1>
                    <div class="data-box" style="margin-left: 10%; margin-top: 30px; position: relative; top: -50px; left: -70%">
                            <h1> ภาพการต่อวงจร</h1>
                            <img src="public\images\sensors\relay2cer.pn" alt="Image Description"width="400" height="400" 
                            style="margin-left: 10%; margin-top: 70px; position: relative; top: 110px;left: -50%">
                </div>
        </div>
                </div>
