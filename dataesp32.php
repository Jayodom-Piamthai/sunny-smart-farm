...
<div class="crown">
    ...
    <div class="stuff">
    <div class="dataitem">
        <h1 style="color: rgb(0, 0, 0); text-align: center;"style="font-size: 90px">ESP32 NodeMCU ESP-WROOM-32 Wi-Fi and Bluetooth Module Dual Core 
            Consumption auto upload 38P</h1>
        <pre>
        <div class="image-container">
            <img src="public/images/sensors/ESP32.jpg" alt="Image Description"width="500" height="400 " 
        ...
        <div class="data-box">
            <h1 style="color: rgb(0, 0, 0);">
                โมดูล Wifi ESP-32 รุ่น ESP-WROOM-32โมดูลWifi+Bluetooth4.2
                +Touch/Temp Sensor ทำงานแบบ Dual Core 
                ที่ความเร็ว 160Mhz มี SRAM 512K 
                หน่วยความจำ Flash สำหรับอัพโหลดโปรแกรมขนาด16M
                มีขาGPIO36ขาความละเอียดในการอ่านค่า ADC 12Bit  
                สามารถเขียนโปรแกรม ผ่าน Arduino IDE 
                เหมือนเขียน Arduino ได้เลย
                โมดูลรวม USB TTL และ ESP-32 ไว้ในตัวแล้วคล้ายกับ NodeMCU 
                จึงไม่ต้องบัดกรีหรือต่อวงจรเพิ่ม ติดตั้งบอร์ดใน Arduino IDE 
                แล้วเสียบสาย USB โปรแกรมได้เลย
            <div class="link-box" style="margin-left: 10%; margin-top: 30px; position: relative; top: -100px; left: -70%">
                <a href="https://www.cybertice.com/product/2747/esp32-nodemcu-esp-wroom-32-wi-fi-and-bluetooth-module-dual-core-consumption-auto-upload-38p?_gl=1*1c2zge4*_up*MQ..&gclid=CjwKCAjw15eqBhBZEiwAbDomEt_r2QvLJRPHaZ9nHvq2Meu5S7swbma9I4WvIJJphgkxbNb6mmuAsxoClt0QAvD_BwE" style="color: rgb(0, 0, 0); ">
                    <h3> ตัวอย่างการเขียนโปรแกรมและการต่วงจร</h3></a>
        </div>
            </h1>
    <div class="image-container">
        <img src="public/images/sensors/esp32pin.png" alt="Image Description"width="1500 " height="800" 
        style="margin-left: 10%; margin-top: 70px; position: relative; top: 110px;left:-70%">
        <img src="public/images/sensors/espspec.gif" alt="Image Description"width="1500 " height="800" 
        style="margin-left: 10%; margin-top: 70px; position: relative; top: 110px;left:-70%">
                </div>
        </div>
    <div class="loginForm" >
