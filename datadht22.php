...
<div class="crown">
    ...
    <div class="stuff">
    <div class="dataitem">
        <h1 style="color: rgb(0, 0, 0); text-align: center;"style="font-size: 90px">DHT 22</h1>
        <pre>
        <div class="image-container">
            <img src="public/images/sensors/dht22.jpg" alt="Image Description"width="400" height="400" 
