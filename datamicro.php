...
<div class="crown">
    ...
    <div class="stuff">
    <div class="dataitem">
        <h1 style="color: rgb(0, 0, 0); text-align: center;"style="font-size: 90px">Micro bit V2 Educational </h1>
        <pre>
        <div class="image-container">
            <img src="public/images/sensors/microbit.gif" alt="Image Description"width="500" height="400 " 
        ...
        <div class="data-box">
            <h1 style="color: rgb(0, 0, 0);">
            Micro bit V2 Educational
            บอร์ดไมโครบิต micro:bit V2 เป็นบอร์ดที่ถูกสร้าง
            เพื่อการศึกษาตั้งแต่ผู้เริ่มต้นเขียนโปรแกรม
            จนถึงใช้งานจริง ด้วยความง่าย
            ในการเขียนโปรแกรมด้วยบล๊อคแค่ลากวางก็เขียนโปรแกรมได้ 
            แถมยังสามารถเขียนด้วยภาษา Python ได้อีกด้วย 
            บอร์ดประกอบไปด้วยเซนเซอร์ built in 
            หลากหลายชนิด ดูได้จากคุณสมบัติด้านล่าง
            ...
            - มีพอร์ตอะนาลอกและดิจิตอล3พอร์ต
            - มีจุดต่อจ่ายไฟบนบอร์ดและคอนเน็กเตอร์สำหรับ
            ต่อกะบะถ่าน3โวลต์
            - ใช้แหล่งจ่ายไฟตรง 3 โวลต์
            - รองรับการทำงานตรวจจับการสัมผัสในแบบ capacitive 
            บนขาพอร์ตหลัก (0 ถึง 2) 
            - มีวงจรตรวจจับการสัมผัสที่โลโก้ของ micro:bit
            ในแบบ capacitive
            - มีลำโพง passive buzzer ในตัว
            - ติดตั้งไมโครโฟน เบอร์ SPU0410LR5H-QB-7 
            พร้อม LED แสดงการทำงาน  
            - มีLED แสดงสถานะการเชื่อมต่อกับพอร์ต USB 
            และ LED แสดงสถานะไฟเลี้ยง 
            - วิธีการใช้ microbit ง่ายมาก แค่มีบอร์ดและอินเตอร์เน็ต
            ก็สามารถเขียนโปรแกรมผ่าน Web browser ได้เพียงแค่เข้าไปที่
            <div class="link-box" style="margin-left: 10%; margin-top: 30px; position: relative; top: -100px; left: -70%">
                <a href="https://www.youtube.com/watch?v=HrAXpeTe4ug" style="color: rgb(0, 0, 0); ">
                    <h3> ตัวอย่างการเขียนโปรแกรม</h3></a>
        </div>
        <div class="link-box" style="margin-left: 10%; margin-top: 30px; position: relative; top: -50px; left:-40%">
            <a href="https://makecode.microbit.org/" style="color: rgb(0, 0, 0); ">
                <h3> เขียนโปรแกรม</h3></a>
    </div>
            </h1>
    <div class="image-container">
        <img src="public/images/sensors/microbitdiagram.jpg" alt="Image Description"width="1000 " height="800" 
