...
<div class="crown">
    ...
    <div class="stuff">
    <div class="dataitem">
        <h1 style="color: rgb(0, 0, 0); text-align: center;"style="font-size: 90px">NRF24L01 Module Wireless</h1>
        <pre>
        <div class="image-container">
            <img src="public/images/sensors/radio.jpg" alt="Image Description"width="400" height="400" 
        ...
        <div class="data-box">
            <h1 style="color: rgb(0, 0, 0);">
                ...
                และความชื้น แนะนำตัวนี้เลย DHT22 High Accuracy Digital Temperature 
                and Humidity Sensor  DHT22 ใช้สำหรับวัดอุณหภูมิและความชื้น 
                ออกแบบมาให้วัดได้แม่นยำกว่ารุ่น DHT11  ใช้ง่ายสามารถนำ DHT22  
                ไปเปลี่ยนแทน DHT11 ได้เลยเพราะโค้ด Arduino DHT22 เขียนเหมือนกัน
