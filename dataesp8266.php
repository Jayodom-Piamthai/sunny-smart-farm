...
<div class="crown">
    ...
    <div class="stuff">
    <div class="dataitem">
        <h1 style="color: rgb(0, 0, 0); text-align: center;"style="font-size: 90px">NodeMCU ESP8266 V2 CH9102 LUA Wifi based ESP8266-12E</h1>
        <pre>
        <div class="image-container">
            <img src="public/images/sensors/esp8266.jpg" alt="Image Description"width="400" height="300 " 
        ...
        <div id="buybut"style="margin-left: 10%; margin-top: 30px; position: relative; top: 40px;left:  30%">
            <h1 id="center2" >เพิ่มลงรถเข็น</h1>
        </div>
        </div>
        <div class="data-box">
            <h1 style="color: rgb(0, 0, 0);">
            NodeMCU V2 ปรับปรุงจาก NodeMCU เวอร์ชันเดิม 
            โดยใช้ ESP8266-12E ซึ่งมีขา GPIO PWM I2C 1-Wire ADC 
            และ SPI เพิ่มเข้ามา มีเสาอากาศในตัว 
            บอร์ดมีขนาดเล็กลง บอร์ดกว้าง 2.5CM ใช้ชิฟ USB 
            เบอร์CH9102ในการติดต่อกับคอมพิวเตอร์เพื่อลงโปรแกรม 
            สามารถลงFirmwareNodeMCU
            และเขียนโปรแกรมด้วยภาษา Lau ได้ 
            <div class="link-box" style="margin-left: 10%; margin-top: 30px; position: relative; top: -100px; left: -70%">
                <a href="https://www.cybertice.com/product/3140/micro-bit-educational-tool-for-kids-bbc-microbit-%E0%B8%8A%E0%B8%B8%E0%B8%94%E0%B8%9A%E0%B8%AD%E0%B8%A3%E0%B9%8C%E0%B8%94-micro-bit-%E0%B9%80%E0%B8%A3%E0%B8%B5%E0%B8%A2%E0%B8%99%E0%B8%A3%E0%B8%B9%E0%B9%89%E0%B9%84%E0%B8%A1%E0%B9%82%E0%B8%84%E0%B8%A3%E0%B8%84%E0%B8%AD%E0%B8%99%E0%B9%82%E0%B8%97%E0%B8%A3%E0%B9%80%E0%B8%A5%E0%B8%AD%E0%B8%A3%E0%B9%8C-v1-0?_gl=1*lji4ba*_up*MQ..&gclid=CjwKCAjw15eqBhBZEiwAbDomEt_r2QvLJRPHaZ9nHvq2Meu5S7swbma9I4WvIJJphgkxbNb6mmuAsxoClt0QAvD_BwE" style="color: rgb(0, 0, 0); ">
                    <h3> ตัวอย่างการต่วงจร</h3></a>
        </div>
            </h1>
    <div class="image-container">
        <img src="public/images/sensors/esp8266pin.png" alt="Image Description"width="1500 " height="800" 
        style="margin-left: 10%; margin-top: 70px; position: relative; top: 110px;left:-70%">
        <img src="public/images/sensors/esp8266diagram.webp" alt="Image Description"width="1500 " height="800" 
        style="margin-left: 10%; margin-top: 70px; position: relative; top: 110px;left:-70%">
                </div>
        </div>
    <div class="loginForm" >
